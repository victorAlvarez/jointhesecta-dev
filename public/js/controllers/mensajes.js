angular.module('jts.mensajes').controller('MensajesController', ['$scope', '$routeParams', '$location', 'Global', 'Mensajes',
    'MisMensajes',
    function ($scope, $routeParams, $location, Global, Mensajes, MisMensajes) {
