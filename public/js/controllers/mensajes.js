angular.module('jts.mensajes').controller('MensajesController', ['$scope', '$routeParams', '$location',
    'Global', 'Mensajes', 'MisMensajes', 'socket',
    function ($scope, $routeParams, $location, Global, Mensajes, MisMensajes, socket) {
        $scope.global = Global;
